...
def test_calc_rrup_rjb_single_point():
    ...
    rrup, rjb = src_site_dist.calc_rrup_rjb(srf_points, locations)
...
def test_calc_rrup_rjb_with_return_points():
    ...
    rrup, rjb, rrup_points = src_site_dist.calc_rrup_rjb(
        srf_points, locations, return_rrup_points=True
    )
...
def test_calc_rrup_rjb_custom_iterations():
    ...
    rrup, rjb = src_site_dist.calc_rrup_rjb(
        srf_points, locations, n_stations_per_iter=1
    )
